...
document.getElementById('infoForm').addEventListener('submit', async function(e) {
    ...
    const unameCheck = await fetch(`http://localhost/Resumix/Backend/user_profile_info_handler.php?field=username&value=${encodeURIComponent(username)}`);
    ...
    const emailCheck = await fetch(`http://localhost/Resumix/Backend/user_profile_info_handler.php?field=email&value=${encodeURIComponent(email)}`);
