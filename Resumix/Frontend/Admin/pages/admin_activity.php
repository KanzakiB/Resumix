    <?php
        ...
        $stmt_count = $conn->prepare("SELECT COUNT(*) FROM rm_activity WHERE id_user = ?");
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 order-md-0 mt-4 mt-md-0">
                            <div class="card list-group custom-shadow tall-box nav-box">
                                ...
                                <a href="admin_activity.php" class="list-group-item list-group-item-action active">Activity Log</a>
                            </div>
                        </div>
                    </div>
                </div>
