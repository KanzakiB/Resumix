<?php
    ...
    $totalQuery = "SELECT COUNT(*) as total FROM rm_user WHERE role = 'user' $searchCondition";
    ...
    if ($sort === 'date_oldest') {
        $filterCondition .= " AND date_joined <= DATE_SUB(CURDATE(), INTERVAL 30 DAY)";
        $orderBy = "ORDER BY date_joined ASC";
    } elseif ($sort === 'date_newest') {
        $orderBy = "ORDER BY date_joined DESC";
    } elseif ($sort === 'name_asc') {
        $orderBy = "ORDER BY firstname ASC, lastname ASC";
    } elseif ($sort === 'name_desc') {
        $orderBy = "ORDER BY firstname DESC, lastname DESC";
    }

    $sql = "SELECT id_user, username, firstname, lastname, email, date_joined, image_profile 
            FROM rm_user 
            WHERE role = 'user' $searchCondition $filterCondition
            $orderBy
...
<body>
    ...
    <div class="main-wrapper">
        <header class="header-main">
            <div class="d-flex align-items-center">
                ...
                <h1 class="header-title d-none d-md-block titleheader">Registered Users</h1>
            </div>
        ...
        <main class="main-content bodybg ">
            <div class="container mt-4">
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        ...
                        <a href="admin_registered_users.php" style="padding-bottom: 8px; margin-right: 20px; text-decoration: none; color: #00085C; font-weight: bold; border-bottom: 2px solid #00085C;">Registered Users</a>
                        <a href="admin_users.php" style="padding-bottom: 8px; text-decoration: none; color: #333;">Admins</a>
                        </div>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="action-icons">
                                                <?php if ($_SESSION['role'] === 'super_admin'): ?>
                                                    <a href="http://localhost/Resumix/Frontend/Admin/pages/users_update.php?id=<?= $user['id_user'] ?>" 
                                                    title="Edit" 
                                                    class="edit-user-btn" 
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <button title="Delete" class="text-danger"><i class="fa-regular fa-trash-can deletebtn text-muted" title="Delete (Disabled)" style="cursor: not-allowed;"></i></button>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
    ...
    <script src="http://localhost/Resumix/Frontend/Admin/js/registered_users.js"></script>
